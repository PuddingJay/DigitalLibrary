      ...
      <>
        ...
        <div className="cardLayout">
            ...
            <ModalBody>
              <Form innerRef={formRef}>
                <FormGroup>
                  ...
                  <Input type="text" name="NIS" id="NIS" value={NIS} onChange={(e) => setNIS(e.target.value)} />
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                  ...
                  <Input type="text" placeholder="contoh 10" name="Kelas" id="Kelas" value={Kelas} onChange={(e) => setKelas(e.target.value)} />
                </FormGroup>
                <FormGroup>
                  <Label for="Jurusan">Jurusan</Label>
                  <Input type="text" name="Jurusan" placeholder="IPA-1" id="Jurusan" value={Jurusan} onChange={(e) => setJurusan(e.target.value)} />
                </FormGroup>
              </Form>
            </ModalBody>
            <ModalFooter>
          ...
          <Modal isOpen={modalUpdate} toggle={toggleModalUpdate}>
            ...
            <ModalFooter>
              <Button type="submit" color="primary" onClick={currentAnggotaId ? () => handleUpdate(currentAnggotaId) : handleAdd}>
                Simpan
              </Button>
